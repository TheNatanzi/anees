...
### M10 — WhatsApp chat as the second source (added 2026-09-05 12:40, after Medi exported the chat)
...
- **M10a — House spelling.** Parse Amal's lines into a spelling table (her Arabizi form → Doc word id, via the M0 loose matcher). Her form becomes the display spelling everywhere Anees prints a word; Scribe's form stays as the match key only.
...
Settled with Medi (grill, 2026-09-05 12:50) for M10c:
...
Sign-off: Codex on M10a/M10b/M10c (gates above stand).
